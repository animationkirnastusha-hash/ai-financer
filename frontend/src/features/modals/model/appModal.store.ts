...
export type AppModalDescriptor =
  ...
  | { type: 'ai-text-overlay'; initialCommand?: string | null; initialAssistantMessage?: string | null; autoSubmitInitialCommand?: boolean; firstRunSetup?: boolean; quickCreateMode?: HomeCashflowMode | null; hiddenCommandPrefix?: string | null }
