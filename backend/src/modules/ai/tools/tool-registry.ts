...
export const AI_TOOL_REGISTRY: AIToolDefinition[] = [
  ...
  },
  {
    ...
    description: 'Rename or change category type/section.',
    risk: 'medium',
    requiresConfirmation: true,
    input: { category: 'string', name: 'string|null', type: 'income|expense|null', section: 'string|null' },
  },
  {
  ...
  },
  {
    ...
    description: 'Move category into section. If section does not exist, backend creates it.',
    risk: 'medium',
    requiresConfirmation: true,
  ...
  {
    name: 'show_taxonomy',
    description: 'Show sections and categories.',
    risk: 'low',
    requiresConfirmation: false,
    input: {},
  },
...
export function getPlannerToolContract() {
  return [
    ...
    'create_category{name,type:income|expense,section}',
    'update_category{category,name,type,section}',
